...
namespace Labarator_1
{
    public partial class picture : Form
    {
        ...
        private void Init()
        {
            ...
            maxSunPosition = width + 50;
            sunPositionTrack.Minimum =-50;
            sunPositionTrack.Maximum = maxSunPosition + 50;
        ...
        /// <summary>
        /// Обработчик переполнения счетчика таймера
        /// </summary>
        private void OnTimerElapsed(object sender, ElapsedEventArgs e)
        {
            if (maxSunPosition <= curSunPosition)
                curSunPosition = 0;
            else
                curSunPosition += 10;
