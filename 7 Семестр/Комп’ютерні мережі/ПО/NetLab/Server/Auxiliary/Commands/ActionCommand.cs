...
namespace Server.Auxiliary
{
    public sealed class ActionCommand : ICommand
    {
        ...
        private ICommand cmdGoToAttachElementOdVideocadr;
        ...
        public ActionCommand(ICommand cmdGoToAttachElementOdVideocadr)
        {
            this.cmdGoToAttachElementOdVideocadr = cmdGoToAttachElementOdVideocadr;
        }
